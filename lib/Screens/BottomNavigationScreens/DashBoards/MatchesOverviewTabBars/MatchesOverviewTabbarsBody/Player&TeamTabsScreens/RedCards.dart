...
class RedCardsScreen extends StatelessWidget {
  ...
  Widget assetsContainer(BuildContext context, int index,
      String redCards, String teamName, String teamLogo)
  {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        trailing: Text(redCards.toString(), style: TextStyle(fontSize: 15, color: Colors.white)),
      ),
    );
  }
