...
class YellowCardsScreen extends StatelessWidget {
  ...
  Widget assetsContainer(BuildContext context, int index,
      String yellowCards, String teamName, String teamLogo)
  {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        trailing: Text(yellowCards.toString(), style: const TextStyle(fontSize: 15, color: Colors.white)),
      ),
    );
  }
