...
import 'MatchesTeamInfo/MatchesFixtures.dart';
import 'MatchesTeamInfo/MatchesResults.dart';
import 'SquadTeamInfo.dart';


class TeamInfoMainScreen extends StatefulWidget {
  ...
  @override
  State<TeamInfoMainScreen> createState() => _TeamInfoMainScreenState();
}

class _TeamInfoMainScreenState extends State<TeamInfoMainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> mainTabMenuScreenList2 = [
      ...
      const HotPage(),
      SquadTeamInfo(widget.teamId, widget.teamName, widget.teamLogo)
    ];

    List<Widget> tabMenuScreensList2 = [
      MatchesFixtures(teamId: widget.teamId,),
      MatchesResults()
    ];
